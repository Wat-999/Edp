# [店铺数据运营](https://github.com/Wat-999/sys/tree/main/Store_data_operation)

1、[竞品调价预警](https://github.com/Wat-999/sys/blob/main/Store_data_operation/Price_adjustment_warning.py)
...
2、[推广方案最优解](https://github.com/Wat-999/sys/blob/main/Store_data_operation/Optimal_solution.py)
...
3、[SEO(搜索引擎)](https://github.com/Wat-999/sys/blob/main/Store_data_operation/SEO.py)
...
# [数字营销](https://github.com/Wat-999/sys/tree/main/digital_marketing)

1、[消费者舆情分析](https://github.com/Wat-999/sys/blob/main/digital_marketing/Consumer_Public_Sentiment_Analysis.py)
...
2、[基于关联规则的产品推荐](https://github.com/Wat-999/sys/blob/main/digital_marketing/ar_Products_Recommended.py)
...
3、[基于聚类算法的商品推荐](https://github.com/Wat-999/sys/blob/main/digital_marketing/clustering_Product_recommendation%20.py)
...
4、[基于协同过滤算法的产品推荐](https://github.com/Wat-999/sys/blob/main/digital_marketing/cf_Products_Recommended.py)

- 项目简介：给消费者推荐商品，提高转化率。
- 作用：给消费者推荐商品，提高转化率。
- 实现思路：使用sklearn.metrics.pairwise库中的pairwise_distances()函数构建协同过滤模型。

# [销售预测](https://github.com/Wat-999/sys/tree/main/Sales_Forecast)

1、[用户成单预测](https://github.com/Wat-999/sys/blob/main/Sales_Forecast/User_order_prediction/User_order_prediction.py)
...
2、[用户流失预测](https://github.com/Wat-999/sys/blob/main/Sales_Forecast/User_Churn_Prediction/User_Churn_Prediction.py)
...
3、[基于时序算法预测库存](https://github.com/Wat-999/sys/blob/main/Sales_Forecast/Prediction_based_on_time_series_algorithm/Prediction_based_on_time_series_algorithm.py)
...
4、[电商的库存预测算法建模](https://github.com/Wat-999/sys/blob/main/Sales_Forecast/Inventory_forecast/Inventory_forecast.py)
...
5、[基于业务逻辑的预测算法模型](https://github.com/Wat-999/sys/blob/main/Sales_Forecast/Prediction_based_on_business_logic/Prediction_based_on_business_logic.py)
...
# [客户价值分析](https://github.com/Wat-999/sys/tree/main/customer_value_analysis)

1、[用户价值分析](https://github.com/Wat-999/sys/blob/main/customer_value_analysis/User%20value%20analysis.ipynb)
