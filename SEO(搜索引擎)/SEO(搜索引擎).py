...
# 读取一个星期商品手淘关键词详情
stss = pd.read_excel('/Users/macbookair/Desktop/数据分析/书本配套资料及电子书/python商业数据分析(零售和电子商务)/《Python商业数据分析：零售和电子商务案例详解》/第四章Python与店铺数据化运营案例/案例：用Python做SEO/无线商品三级流量来源详情.xls')
# 读取需要的数据
